...
sudo apt install trsync</code>
    ...
    <div class="card">
      ...
      <div class="screenshots-grid">
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_trsync_1.jpg')">
          <img src="screenshots/screenshot_trsync_1.jpg" alt="TRsync Main Window">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_trsync_2.jpg')">
          <img src="screenshots/screenshot_trsync_2.jpg" alt="TRsync Advanced Options">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_trsync_3.jpg')">
          <img src="screenshots/screenshot_trsync_3.jpg" alt="TRsync Encryption Settings">
        </div>
        <div class="screenshot-thumb" onclick="openModal('screenshots/screenshot_trsync_4.jpg')">
          <img src="screenshots/screenshot_trsync_4.jpg" alt="TRsync Sync Execution">
        </div>
      </div>
    </div>
